...
ray1_1  = [0,0,1]';
ray1_2  = normc([1,0,1]');
ray1_3  = normc([cos(10/180*pi), sin(10/180*pi), 0]');
ray1_4  = normc([sin(10/180*pi), cos(10/180*pi), 0]');
ray1_5  = normc([0, cos(10/180*pi), sin(10/180*pi)]');
ray1    = [ray1_1, ray1_2, ray1_3, ray1_4, ray1_5];

ray2_1  = [0,1,0]';
ray2_2  = normc([-sin(20/180 *pi),0,cos(20/180 *pi)]');
ray2_3  = normc([-1,1,-1]');
ray2    = [ray2_1, ray2_2, ray2_3];
...
for N =  size_range
    parfor i=1:trial_max
        ...
        % save file
        filename = [p,'3DSynthetic_Size', num2str(N), '_Trial', num2str(i),'.mat'];
...
for s = 1: length(size_range)
    ...
    for t = 1:trial_max
        ...
        filename = ['3DSynthetic_Size' num2str(Size) '_Trial' num2str(t) '.mat'];
        load(filename);
        % SSC
